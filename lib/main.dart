...
import 'package:expense_tracker/pages/metas_cadastro.dart';
...
void main() async {
  await Supabase.initialize(
    url: 'https://aaalutpkobkibexfauiu.supabase.co',
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFhYWx1dHBrb2JraWJleGZhdWl1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTc1MDAyMjIsImV4cCI6MjAxMzA3NjIyMn0.6-qc-qn3JyJRvXVFGQBfpSfVhiqBjoUuHBNfrPyPAfA',
  );
  runApp(const MyApp());
}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        "/metas-cadastro": (context) => const MetasCadastro(),
      },
      initialRoute: "/splash",
    );
  }
